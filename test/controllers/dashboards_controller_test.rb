...
class DashboardsControllerTest < ActionController::TestCase
  ...
  test "should create dashboard" do
    assert_difference('Dashboard.count') do
      post :create, dashboard: { budget: @dashboard.budget, calls: @dashboard.calls, clicks: @dashboard.clicks, cost: @dashboard.cost, devise: @dashboard.devise, searches: @dashboard.searches, website_id: @dashboard.website_id }
    end
  ...
  test "should update dashboard" do
    patch :update, id: @dashboard, dashboard: { budget: @dashboard.budget, calls: @dashboard.calls, clicks: @dashboard.clicks, cost: @dashboard.cost, devise: @dashboard.devise, searches: @dashboard.searches, website_id: @dashboard.website_id }
    assert_redirected_to dashboard_path(assigns(:dashboard))
  end
